...
public class CanvasImplIE8 extends CanvasImplIE {
     ...
     * 
     * @see
     * com.competition.chart.visualisation.client.ui.canvas.client.impl.ie.CanvasImplIE#stroke()
     */
    @Override
    public void stroke() {
     ...
     * 
     * @see
     * com.competition.chart.visualisation.client.ui.canvas.client.impl.ie.CanvasImplIE#fill()
     */
    @Override
    public void fill() {
        if (pathStack.isEmpty()) {
