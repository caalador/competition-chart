...
package com.competition.chart.visualisation.client.ui.canvas.client;
...
public class Image {
    ...
    private native ImageElement getNativeHandle() /*-{
                                                  ...
                                                  self.@com.competition.chart.visualisation.client.ui.canvas.client.Image::invokeCallback()();
                                                  image.onload = null;
                                                  }
                                                  return image;
                                                  }-*/;
